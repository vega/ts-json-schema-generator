...
describe("valid-data-other", () => {
    ...
    it("generic-mapped-complex", assertValidSchema("generic-mapped-complex", "*", { encodeRefs: true }));
    it("generic-valueof", assertValidSchema("generic-valueof", "*", { encodeRefs: true }));
